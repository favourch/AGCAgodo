...
<center>
  ...
  $(document).ready( function () {
    ...
    function edit_book(id)
    {
      ...
      $.ajax({
        url : "<?php echo site_url('index.php/book_view/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
    ...
    function save()
    {
      ...
      if(save_method == 'add')
      {
          url = "<?php echo site_url('index.php/book_view/book_add')?>";
      }
      else
      {
        url = "<?php echo site_url('index.php/book_view/book_update')?>";
      }
    ...
    function delete_book(id)
    {
      if(confirm('Are you sure delete this data?'))
      {
        // ajax delete data from database
          $.ajax({
            url : "<?php echo site_url('index.php/book_view/book_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
